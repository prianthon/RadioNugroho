...
$(document).ready(function() {
  ...
  AP.init({
    playList: [{
      'icon': iconImage,
      'title': 'PadukaFM',
      'file': 'http://paduka.id.myradio.web.id:8888/padukafm?1502512691889'
    }, {
      'icon': iconImage,
      'title': 'BahanaFM',
      'file': 'http://live.bahanafm.co.id:8102/;'
    }, {
      'icon': iconImage,
      'title': 'PramborsFM',
      'file': 'http://masima.rastream.com/masima-pramborsjakarta?'
    }, {
      'icon': iconImage,
      'title': 'SuaraGiriFM',
      'file': 'http://streaming.girifm.com:8010/;'
    }, {
      'icon': iconImage,
      'title': 'NagaswaraFM',
      'file': 'http://bogor.nagaswarafm.com:8088/;'
    }]
  });
